...
using GuideUAPP.Models;

namespace GuideUAPP.Models
{
    ...
    public class YouTubeChannelPageModel : FreshBasePageModel
    {
        ...
        const string ApiKey = "AIzaSyAR1h6DMyTLrcnuo17O7pqnY4WyPpdSQRo";
        const string ChannelId = "UCE8NoMFnai3tTuwdiQJ-78A";
